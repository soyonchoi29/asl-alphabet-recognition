...
if __name__ == '__main__':
    ...
    X_pca_kaggle = pickle.load(open('X_pca_3_kaggle.sav', 'rb'))
    y_kaggle = pickle.load(open('y_kaggle.sav', 'rb'))

    X_pca_webcam = pickle.load(open('X_pca_3_webcam.sav', 'rb'))
    y_webcam = pickle.load(open('y_webcam.sav', 'rb'))
